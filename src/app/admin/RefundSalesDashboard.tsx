...
export default function RefundSalesDashboard({
    refundData,
    totalRefunds,
    totalSales,
    ...
    return (
        <div className="w-full min-h-screen flex flex-col items-center bg-gradient-to-br from-blue-50 via-white to-blue-100 py-8 px-2">
            <button
                ...
                className="mb-6 px-4 py-2 rounded bg-blue-500 text-white font-bold hover:bg-blue-700 transition"
            >
                ← Return to Admin Overview
            </button>
            <h2 className="text-4xl font-extrabold mb-10 text-pink-700 text-center tracking-tight drop-shadow-lg">
                Refund Sales Dashboard
            </h2>
