...
export default function AdminDashboardOverview({
    ...
    return (
        <div className="w-full min-h-screen flex flex-col items-center bg-gradient-to-br from-blue-50 via-white to-blue-100 py-10 px-2">
            <h1 className="text-5xl font-extrabold mb-12 text-center tracking-tight text-blue-900 drop-shadow-lg">
                Admin Dashboard
            </h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 md:grid-cols-4 gap-10 mb-16">
                    {statCards.map((card, idx) => (
                        <div
                            ...
                            onClick={
                                cardLinks[card.title]
                                    ? () =>
                                          router.push(
                                              cardLinks[card.title] as string,
                                          )
                                    : undefined
                            }
                        >
                            <span className="text-4xl mb-2">{card.icon}</span>
                            <div className="text-xl text-white/90 font-semibold mb-1 text-center w-full">
                                {card.title}
                            </div>
                            <div className="font-extrabold text-4xl drop-shadow-lg text-center w-full">
                                {card.value}
                            </div>
                        </div>
                    ))}
