...
export default function ProductTopSalesDashboard({ topProducts }: { topProducts: { id: string, name: string, count: number }[] }) {
  ...
  return (
    <div className="container my-6 flex flex-col items-center">
      ...
      <h2 className="text-3xl font-bold mb-6 text-teal-700 text-center">Top Products Sales</h2>
