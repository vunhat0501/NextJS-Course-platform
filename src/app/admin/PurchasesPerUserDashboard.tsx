...
export default function PurchasesPerUserDashboard({ purchasesPerUserData, averagePurchases }: {
  purchasesPerUserData: { user: string, userName?: string, purchases: number }[],
  ...
  return (
    <div className="container my-6 flex flex-col items-center">
      ...
      <h2 className="text-3xl font-bold mb-6 text-purple-700 text-center">Purchases Per User Dashboard</h2>
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center mb-8">
        <h3 className="text-xl font-bold mb-4 text-purple-600">Top 10 Users by Purchases</h3>
        ...
        <div className="mt-6 text-lg">Average purchases per user: <span className="font-bold text-purple-600">{averagePurchases.toFixed(2)}</span></div>
      </div>
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center">
        <h3 className="text-xl font-bold mb-4 text-purple-600">Top Users</h3>
