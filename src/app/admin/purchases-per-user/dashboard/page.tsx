...
export default async function PurchasesPerUserDashboardPage() {
  ...
  const purchasesPerUserData: { user: string; userName?: string; purchases: number }[] = rawPurchasesPerUserData.map((u: any) => ({ ...u, userName: u.userName ?? undefined }));
  ...
  return <PurchasesPerUserDashboard purchasesPerUserData={purchasesPerUserData} averagePurchases={averagePurchases} />;
} 